...
wd_raster_out <- paste(getwd(), '/Rasters/Rasters_out/CorrOverlayAll', sep='')

# location to READ rasters
wd_raster_in <- paste(getwd(), '/Rasters/Rasters_in', sep='')

# location to save images
wd_image <- paste(getwd(), '/Results/CorrOverlayAll', sep='')
...
res_RPIg_thresh3 <- c(res_RPIg_min,c(0.01,1.0),res_RPIg_max)
...
re_interp_tab3_RPIg <- as.matrix(read.xlsx(paste(wd_error_interp,'/re_RPIg_pfvar3_NewThresh.xlsx',sep=''),1,header=FALSE))
...
re_interp_tab3_RPIw_ls <- as.matrix(read.xlsx(paste(wd_error_interp,'/re_RPIw_pfvar3_ls_NewThresh.xlsx',sep=''),1,header=FALSE))
re_interp_tab3_RPIg_ls <- as.matrix(read.xlsx(paste(wd_error_interp,'/re_RPIg_pfvar3_ls_NewThresh.xlsx',sep=''),1,header=FALSE))
...
co_pfa_var3_geomean_rfc_geo <- calc(stack(co_3_0_27_p_rfc_geo,co_3_0_27_p_rfc_geo,co_uncer_geomean2),fun=prod)

uncer_temp <- stack(re_pfa_var3_rfc_ls,th_pfa_var3_old_ls,se_pfa_var3_ls)
uncer_temp[uncer_temp < 0] <- NA
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var3_geomean_rfc_oldth_geo <- calc(stack(co_3_0_27_p_rfc_oldth_geo,co_3_0_27_p_rfc_oldth_geo,co_uncer_geomean2),fun=prod)

uncer_temp <- stack(re_pfa_var3_RPIw_ls,th_pfa_var3_ls,se_pfa_var3_ls)
uncer_temp[uncer_temp < 0] <- NA
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var3_geomean_RPIw_geo <- calc(stack(co_3_0_27_p_RPIw_geo,co_3_0_27_p_RPIw_geo,co_uncer_geomean2),fun=prod)

uncer_temp <- stack(re_pfa_var3_RPIw_ls,th_pfa_var3_old_ls,se_pfa_var3_ls)
uncer_temp[uncer_temp < 0] <- NA
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var3_geomean_RPIw_oldth_geo <- calc(stack(co_3_0_27_p_RPIw_oldth_geo,co_3_0_27_p_RPIw_oldth_geo,co_uncer_geomean2),fun=prod)

uncer_temp <- stack(re_pfa_var3_RPIg_ls,th_pfa_var3_ls,se_pfa_var3_ls)
uncer_temp[uncer_temp < 0] <- NA
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var3_geomean_RPIg_geo <- calc(stack(co_3_0_27_p_RPIg_geo,co_3_0_27_p_RPIg_geo,co_uncer_geomean2),fun=prod)

uncer_temp <- stack(re_pfa_var3_RPIg_ls,th_pfa_var3_old_ls,se_pfa_var3_ls)
uncer_temp[uncer_temp < 0] <- NA
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var3_geomean_RPIg_oldth_geo <- calc(stack(co_3_0_27_p_RPIg_oldth_geo,co_3_0_27_p_RPIg_oldth_geo,co_uncer_geomean2),fun=prod)
...
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var5_geomean_rfc_oldth_geo <- calc(stack(co_5_0_125_p_rfc_oldth_geo,co_5_0_125_p_rfc_oldth_geo,co_uncer_geomean2),fun=prod)
...
co_uncer_geomean1 <- calc(uncer_temp,fun=sum)
co_uncer_geomean2 <- calc(co_uncer_geomean1,fun=function(x){return(x/9)})
co_pfa_var5_geomean_RPIw_oldth_geo <- calc(stack(co_5_0_125_p_RPIw_oldth_geo,co_5_0_125_p_RPIw_oldth_geo,co_uncer_geomean2),fun=prod)
